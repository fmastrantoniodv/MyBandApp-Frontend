...
const AudioWaveform = ({ sample }) => {
	console.log('AudioWaveForm.sampleIN')
	console.log(sample)
	const wavesurferRef = useRef(null);
	const timelineRef = useRef(null);

	const sampleFileName = getFileName(sample);
	// fetch file url from the context
	const { fileURL, setFileURL } = useState(sample);
	console.log('AudioWaveForm.sample._src')
	console.log(sample._src)
	
	console.log('AudioWaveForm.fileURL')
	console.log(fileURL)
